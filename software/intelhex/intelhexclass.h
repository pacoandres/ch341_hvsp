...
* \github https://github.com/codinghead/Intel-HEX-Class
...
class intelhex {
    ...
    public:
        ...
        ***********************************************************************/
        //PAco 20220617: body function added. It was empty.
        bool insertData(unsigned char data){
          ihContent.insert (std::pair <unsigned long, unsigned char> (currentAddress (), data));
          incrementAddress ();
          return true;
        }
